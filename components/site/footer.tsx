export function Footer() {
  return (
  <footer className="border-t mt-16 bg-gradient-to-r from-cyan-900 via-black to-pink-900 text-white shadow-lg w-full">
      <div className="container py-10 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex flex-col items-center md:items-start">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-xl font-bold tracking-wide">Kolam Ai</span>
            <span className="text-pink-400 animate-pulse">✦</span>
          </div>
          <p className="text-sm opacity-90">Crafted with devotion and creativity, inspired by the timeless art of Kolam.</p>
          <p className="text-xs mt-2 italic text-cyan-200">SciDivine – Where Science Meets the Divine.</p>
        </div>
        <div className="flex flex-col items-center md:items-end">
          <p className="text-sm opacity-80">&copy; {new Date().getFullYear()} Kolam Ai. All rights reserved.</p>
          <div className="flex gap-3 mt-2">
            <a href="https://github.com/iapoorv01/KOLAM-AI" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400 transition-colors" aria-label="GitHub">
            ...
            <a href="mailto:scidivine.team@gmail.com" className="hover:text-cyan-400 transition-colors" aria-label="Email">
