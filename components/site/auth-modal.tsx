...
export function SignInForm({ onSuccess }: { onSuccess?: () => void }) {
  ...
  return (
    <Card className="w-full max-w-md p-8 shadow-xl rounded-2xl border bg-card text-card-foreground mx-auto mt-16">
      <h2 className="text-3xl font-extrabold mb-6 text-center text-primary">Sign In</h2>
...
export function SignUpForm({ onSuccess }: { onSuccess?: () => void }) {
  ...
  return (
    <Card className="w-full max-w-md p-8 shadow-xl rounded-2xl border bg-card text-card-foreground mx-auto mt-16">
      <h2 className="text-3xl font-extrabold mb-6 text-center text-primary">Sign Up</h2>
